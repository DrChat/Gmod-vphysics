...
#define BT_PROFILE_SCOPE_ENTER( name )	CProfileManager::Start_Profile( name );
#define BT_PROFILE_SCOPE_EXIT()			CProfileManager::Stop_Profile();

#else // BT_NO_PROFILE

#define	BT_PROFILE( name )

#define BT_PROFILE_SCOPE_ENTER( name )
#define BT_PROFILE_SCOPE_EXIT()
